...
export default function LoginPage() {
  ...
  return (
    <div className="w-full h-full flex flex-col justify-center items-center">
      <div className="flex items-center gap-2 bg-black p-5 rounded-xl mt-5">
        <Image
          src="/logo.svg"
          alt="Logo"
          width={128}
      ...
      <div className="flex flex-col  w-full mt-10 max-w-2xl bg-[#0f0f12] border border-gray-800 p-6 rounded-lg shadow-2xl shadow-blue-500 hover:shadow-blue-900 mx-auto ">
